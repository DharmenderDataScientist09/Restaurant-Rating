...
scaler = Sjoblib.load("Scaler.pkl")

st.title("Restaurant Rating")

st.caption("This app helps you to predict restaurants review")

st.divider()

averagecost = st.number_input("Please enter the estimated average cost of two", min_value = 50, max_value = 9999, value = 1000, step = 200)
...
averagecost = scaler.fit_transorm(averagecost)

bookingstatus = scaler.fit_transorm(bookingstatus)

deliverystatus = scaler.fit_transorm(deliverystatus)
